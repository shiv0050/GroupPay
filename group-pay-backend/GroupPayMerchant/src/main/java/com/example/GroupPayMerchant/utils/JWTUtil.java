package com.example.GroupPayMerchant.utils;
...
public class JWTUtil implements Serializable, EnvironmentAware {
    ...
    public static final long JWT_TOKEN_VALIDITY = 3600 * 60;
    private String secret;
    private final String ISSUER = "dev.GroupPay.merchant-user-auth";
