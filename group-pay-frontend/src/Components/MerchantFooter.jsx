...
export default function MerchantFooter() {
  return (
    <MDBFooter className='text-center text-white' style={{ width:"full",position:"relative",bottom:'0px',backgroundColor: '#0d6efd' }}>
      <MDBContainer className='p-4'>
        ...
        <div className='text-center p-3' style={{ backgroundColor: '#0d6efd', padding:'0px' ,margin:'0px'}}>
        © 2020 Copyright;
      </div>
      </MDBContainer>
